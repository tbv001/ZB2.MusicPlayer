...
**Music Player** is a mod for **Zumbi Blocks 2** that allows players to add custom background music for various game states (Menu, Time Until First Wave, Active Waves, and Boss Fights).
...
Refer to the `_Instructions.txt` file in the `Music` folder.
